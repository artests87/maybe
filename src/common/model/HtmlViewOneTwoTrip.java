 ...
 */
public class HtmlViewOneTwoTrip implements View,Callable<Boolean>{
    ...
    public HtmlViewOneTwoTrip(Map<Calendar,LinkedHashSet<Calendar>> mapCalendar, String toStart, String fromStart, int methodSearch, String folder,
                              String fileSave) {
        this.folder = folder;
    ...
    private void searchDouble(){
        for (Map.Entry<Calendar,LinkedHashSet<Calendar>> pair:mapCalendar.entrySet()){
            try {
                ...
                String dateDepartureTo = dateTemp + monthTemp;
                ...
                for (Calendar x : pair.getValue()) {
                    ...
                    try {
                        ...
                        dateDepartureFrom =dateTemp + monthTemp;
            ...
            try {
                ...
                for (Calendar x : pair.getValue()) {
                    ...
                    try {
                        ...
                        dateDepartureTo = dateTemp + monthTemp;
