 ...
 */
public class HtmlViewKayak implements View,Callable<Boolean>{
    ...
    public HtmlViewKayak(Map<Calendar,LinkedHashSet<Calendar>> mapCalendar, String toStart, String fromStart, int methodSearch, String folder,
                         String fileSave) {
        this.folder = folder;
            ...
            try {
                ...
                for (Calendar x : pair.getValue()) {
                    ...
                    try {
                        ...
                        dateDepartureFrom = x.get(Calendar.YEAR) + "-" + monthTemp + "-" + dateTemp;
